  ...
  function projects(data, state) {
    ...
    return (
      head(
        ...
        `<button id="toggle-projects" class="quiet-button" type="button" aria-expanded="false" ${rows.length ? "" : "disabled"}>Expand all</button><button class="primary-button" data-action="add-project">+ Add project</button>`,
      ) +
